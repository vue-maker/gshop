    ...
    <div class="ratings-content">
      ...
      <div class="rating-wrapper">
        <ul>
          <li
            class="rating-item"
            v-for="(rating, index) in fillterRatings"
            :key="index"
          >
            <div class="avatar">
